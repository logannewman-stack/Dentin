...
export function VendorStatus({ hasAccount, isPreferred, className }) {
  if (isPreferred) {
    return (
      <span
        className={cn(
          'inline-flex shrink-0 items-center gap-1 rounded-[3px] bg-brand-600/10 px-1.5 py-[1px] text-caption font-semibold ring-1 ring-inset ring-brand-600/25 text-brand-700 dark:text-brand-400',
          className,
        )}
      >
  ...
  if (hasAccount) {
    return (
      <span
        className={cn(
          'inline-flex shrink-0 items-center gap-1 rounded-[3px] bg-ios-green/10 px-1.5 py-[1px] text-caption font-semibold text-ios-green ring-1 ring-inset ring-ios-green/25',
          className,
        )}
      >
  ...
  return (
    <span
      className={cn(
        'inline-flex shrink-0 items-center gap-1 rounded-[3px] px-1.5 py-[1px] text-caption2 font-bold uppercase tracking-[0.06em] text-white',
        className,
      )}
