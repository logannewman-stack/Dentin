    ...
    <div className="flex h-[100dvh] flex-col bg-canvas">
      ...
      >
        <div className="flex items-center gap-3">
          <button
            ...
            onClick={() => go(-1)}
            aria-label="Back"
            className="press flex h-9 w-9 shrink-0 items-center justify-center rounded-[5px] border border-line bg-surface text-label"
          >
      ...
      <div className="scroll-area flex-1 overflow-y-auto px-5">
        <AnimatePresence mode="wait" initial={false} custom={direction}>
          ...
          >
            <span className="mt-4 flex h-11 w-11 items-center justify-center rounded-[6px] bg-brand-600 text-white">
      ...
      >
        <button
          ...
          onClick={() => go(1)}
          className="flex h-[50px] w-full items-center justify-center gap-2 rounded-[6px] bg-brand-600 text-body font-semibold text-white transition-opacity active:opacity-85 disabled:opacity-40"
        >
